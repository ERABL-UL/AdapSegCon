...
def datapath_list(root, seq_ids, split):
    ...
    for seq in seq_ids:
        if dataset == "KITTI360":
            ...
            point_seq_path = os.path.join(root, split, 'sequences', seq, velodyne)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='KITTI360' ,
                        help='Name_of_the_dataset')
    parser.add_argument('--split', type=str, default='train',
                        help='split set (default: train')
    parser.add_argument('--root', type=str, default='path_to_the_dataset_folder',
